...
/**
 * <p>Description: Lambda Functions </p>
 *
...
// 1. A lambda in all its glory, with explicit types everywhere.
...
// 5. For lambdas with a single parameter, you don't have to explicitly name it. Instead, you can use the implicit it variable.
