...
/**
 * <p>Description: Object Keyword </p>
 *
...
// To achieve this in Kotlin, you only need to declare an object: no class, no constructor, only a lazy instance. Why lazy?
//   Because it will be created once when the object is accessed. Otherwise, it won't even be created.

/**
 * <p>Description: object Expression </p>
 *
 * Here is a basic typical usage of an object expression: a simple object/properties structure. There is no need to do so in class declaration:
...
/**
 * <p>Description: object Declaration </p>
 *
...
/**
 * <p>Description: Companion Objects 同伴对象</p>
 *
